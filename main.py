...
if __name__ == '__main__':
    ...
    parser.add_argument('--smtp-port', help='TCP port to use when sending the email; default=25', type=int, choices=['25', '587'], default='25')
    ...
    # Once args are parsed, import config
    import config
